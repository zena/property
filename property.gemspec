...
Gem::Specification.new do |s|
  ...
  s.date = "2015-04-29"
  s.description = "Wrap model properties into a single database column and declare properties from within the model."
  ...
  s.homepage = "http://zenadmin.org/635"
  s.licenses = ["MIT"]
  s.rubyforge_project = "property"
  s.rubygems_version = "2.4.6"
  s.summary = "model properties wrap into a single database column"
